...
KERNEL_FQ void m05710_init (KERN_ATTR_TMPS (sha256_tmp_t))
{
...
KERNEL_FQ void m05710_loop (KERN_ATTR_TMPS (sha256_tmp_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void m05710_comp (KERN_ATTR_TMPS (sha256_tmp_t))
{
  const u64 gid = get_global_id (0);
