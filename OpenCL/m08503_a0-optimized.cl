...
KERNEL_FQ void m08503_m04 (KERN_ATTR_RULES ())
{
  ...
  salt_buf2[2] = salt_bufs[SALT_POS].salt_buf_pc[10];
  salt_buf2[3] = salt_bufs[SALT_POS].salt_buf_pc[11];
  salt_buf3[0] = salt_bufs[SALT_POS].salt_buf_pc[12];
  salt_buf3[1] = salt_bufs[SALT_POS].salt_buf_pc[13];
...
KERNEL_FQ void m08503_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m08503_m16 (KERN_ATTR_RULES ())
{
}
...
KERNEL_FQ void m08503_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m08503_s16 (KERN_ATTR_RULES ())
{
}
